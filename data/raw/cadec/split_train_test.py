...
if __name__ == "__main__":
    train_set = [l.strip() for l in open("data/raw/cadec/split/train.id").readlines()]
    dev_set = [l.strip() for l in open("data/raw/cadec/split/dev.id").readlines()]
    test_set = [l.strip() for l in open("data/raw/cadec/split/test.id").readlines()]
